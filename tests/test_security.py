...
def test_keyboards_produce_valid_callback_data():
    ...
    keyboards = [
        ...
        admin_services_kb([service], "ru"),
        admin_service_kb(service, "ru"),
        admin_barbers_kb([barber], "ru"),
        admin_barber_kb(barber, "ru"),
        week_kb(sample, dict.fromkeys(range(7)), "ru"),
        weekday_actions_kb(sample, 6, "ru"),
        exceptions_kb([exception], "ru"),
        admin_appointments_kb([appointment], page=0, has_next=True, lang="ru"),
        admin_appointment_kb(sample, "ru"),
    ]
